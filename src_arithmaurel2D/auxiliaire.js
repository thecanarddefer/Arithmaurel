...
function ajustPasRAZ() {
    if (Delai >= 475) { pasRAZ = 1 / 100 } else if (Delai >= 350) { pasRAZ = 1 / 32 } else if (Delai >= 225) { pasRAZ = 1 / 16 } else { pasRAZ = 1 / 8 }
}
...
function RAZflechBoucle() {
    ...
    if (nonzero) { setTimeout(function() { RAZflechBoucle(); }, 100) } else { zeroflech = true;
        document.getElementById('cadran').innerHTML = '&nbsp;0 0 0 0&nbsp;'; };
}


/**
 * 
 * Fonction de remise a zero du disque 
 */
function RAZdisk(j) {
...
function simulation(mode) { // entrées = data et inputTiret(8), sortie = resultat(8).
    ...
    for (var i = 0; i < 8; i++) {
        while (resultat[i] >= 10) { resultat[i] -= 10;
            resultat[i + 1]++ };
        while (resultat[i] < 0) { resultat[i] += 10;
            resultat[i + 1]-- };
...
function exempleAddition(pas) {
    ...
    switch (pas) {
        case 1:
            ...
            break;
        case 2:
            if (zerodisk && zeroflech) { setTimeout(function() { exempleAddition(pas + 1); }, Delai); } else { setTimeout(function() { exempleAddition(pas); }, Delai); }
            break;
        case 3:
            SETflect(3, 1);
            setTimeout(function() { exempleAddition(pas + 1); }, nbDelai * Delai);
...
function exempleSoustraction(pas) {
    ...
    switch (pas) {
        case 1:
            ...
            break;
        case 2:
            if (zerodisk && zeroflech) { setTimeout(function() { exempleSoustraction(pas + 1); }, Delai); } else { setTimeout(function() { exempleSoustraction(pas); }, Delai); }
            break;
        case 3:
            SETflect(3, 1);
            setTimeout(function() { exempleSoustraction(pas + 1); }, nbDelai * Delai);
...
function exempleMultiplication(pas) {
    ...
    switch (pas) {
        case 1:
            ...
            break;
        case 2:
            if (zerodisk && zeroflech) { setTimeout(function() { exempleMultiplication(pas + 1); }, Delai); } else { setTimeout(function() { exempleMultiplication(pas); }, Delai); }
            break;
        case 3:
            ...
            break;
        case 4:
            if (!SetFlecDone) { setTimeout(function() { exempleMultiplication(pas); }, Delai); } else {
...
function exempleDivision(pas) {
    ...
    switch (pas) {
        case 1:
            ...
            break;
        case 2:
            if (zerodisk && zeroflech) { setTimeout(function() { exempleDivision(pas + 1); }, Delai); } else { setTimeout(function() { exempleDivision(pas); }, Delai); }
            break;
        case 3:
            SETflect(3, 1);
            setTimeout(function() { exempleDivision(pas + 1); }, nbDelai * Delai);
        ...
        case 6:
            ...
            break;
        case 7:
            if (!SetFlecDone) { setTimeout(function() { exempleDivision(pas); }, Delai); } else {
        ...
        case 10:
            if (!SetFlecDone) { setTimeout(function() { exempleDivision(pas); }, Delai); } else {
                ...
                setTimeout(function() { exempleDivision(pas + 1); }, 100 * Delai);
            } // 9000
            break;
        case 11:
            if (!arithBisi) {
...
function exempleSigma(pas) {
    ...
    switch (pas) {
        case 1:
            ...
            break;
        case 2:
            if (zerodisk && zeroflech) { setTimeout(function() { exempleSigma(pas + 1); }, Delai); } else { setTimeout(function() { exempleSigma(pas); }, Delai); }
            break;
        case 3:
            ...
            break;
        case 4:
            if (!SetFlecDone) { setTimeout(function() { exempleSigma(pas); }, Delai); } else {
                SETflect(1, (Math.trunc(adend2 / 100)) % 10);
                setTimeout(function() { exempleSigma(pas + 1); }, nbDelai * Delai);
            }
            break;
        ...
        case 8:
            ...
            break
        case 9:
            if (zeroflech) { setTimeout(function() { exempleSigma(pas + 1); }, Delai); } else { setTimeout(function() { exempleSigma(pas); }, Delai); }
            break;
        case 10:
